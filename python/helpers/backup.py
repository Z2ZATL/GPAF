...
class BackupService:
    """
    Core backup and restore service for GPAF.
    ...
    def __init__(self):
        ...
        self.gpaf_root = files.get_abs_path("")  # Resolved GPAF root

        # Build base paths map for pattern resolution
        self.base_paths = {
            self.gpaf_root: self.gpaf_root,
        }
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes GPAF project directory patterns.
        """
        # Ensure paths don't have double slashes
        agent_root = self.gpaf_root.rstrip('/')

        return f"""# GPAF Knowledge (excluding defaults)
{agent_root}/knowledge/**
!{agent_root}/knowledge/default/**

# GPAF Instruments (excluding defaults)
