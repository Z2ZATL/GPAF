...
class SettingsSection(TypedDict, total=False):
    id: str
    icon: str  # Optional custom icon name (without .svg extension)
    title: str
    description: str
...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by GPAF",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by GPAF",
    ...
    embed_model_section: SettingsSection = {
        ...
        "description": "Settings for the embedding model used by GPAF.",
    ...
    browser_model_section: SettingsSection = {
        ...
        "description": "Settings for the web browser model. GPAF uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> agentic framework to handle web interactions.",
    ...
    auth_section: SettingsSection = {
        ...
        "description": "Settings for authentication to use GPAF Web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
        "description": "API keys for model providers and services used by GPAF.",
    ...
    agent_fields.append(
        {
            ...
            "description": "Subdirectory of /prompts folder to be used by default agent. Subordinate agents can be spawned with other subdirectories, that is on their superior agent to decide. This setting affects the behaviour of the top level agent you communicate with.",
            "type": "select",
    ...
    if runtime.is_development():
        ...
        #         "description": "Automatically create dockerized instance of GPAF for RFCs using this instance's code base and, settings and .env.",
        #         "type": "text",
        ...
        dev_fields.append(
            {
                ...
                "description": "URL of dockerized GPAF instance for remote function calls. Do not specify port here.",
                "type": "text",
        ...
        dev_fields.append(
            {
                "id": "rfc_port_http",
                "title": "RFC HTTP port",
                "description": "HTTP port for dockerized instance of GPAF.",
                "type": "text",
        ...
        dev_fields.append(
            {
                "id": "rfc_port_ssh",
                "title": "RFC SSH port",
                "description": "SSH port for dockerized instance of GPAF.",
                "type": "text",
    ...
    dev_section: SettingsSection = {
        "id": "dev",
        "title": "Development",
        "description": "Parameters for GPAF framework development. RFCs (remote function calls) are used to call functions on another GPAF instance. You can develop and debug GPAF natively on your local system while redirecting some functions to GPAF instance in docker. This is crucial for development as GPAF needs to run in standardized environment to support all features.",
        "fields": dev_fields,
        "tab": "developer",
    }
    ...
    mcp_client_section: SettingsSection = {
        ...
        "description": "GPAF can use external MCP servers, local or remote as tools.",
    ...
    mcp_server_fields.append(
        {
            ...
            "title": "Enable GPAF MCP Server",
            "description": "Expose GPAF as an SSE MCP server. This will make this GPAF instance available to MCP clients.",
            "type": "switch",
    ...
    mcp_server_section: SettingsSection = {
        "id": "mcp_server",
        "icon": "dev",  # Using dev icon for development tools/API server
        "title": "GPAF MCP Server",
        "description": "GPAF can be exposed as an SSE MCP server. See <a href=\"javascript:openModal('settings/mcp/server/example.html')\">connection example</a>.",
    ...
    backup_section: SettingsSection = {
        ...
        "description": "Backup and restore GPAF data and configurations "
...
def _adjust_to_version(settings: Settings, default: Settings):
    # starting with 0.9, the default prompt subfolder for agent no. 0 is gpaf (renamed from agent0)
    # switch to gpaf if the old default is used from v0.8 or agent0 from previous versions
    if "version" not in settings or settings["version"].startswith("v0.8"):
        if "agent_prompts_subdir" not in settings or settings["agent_prompts_subdir"] == "default":
            settings["agent_prompts_subdir"] = "gpaf"
    # migrate from agent0 to gpaf
    if "agent_prompts_subdir" in settings and settings["agent_prompts_subdir"] == "agent0":
        settings["agent_prompts_subdir"] = "gpaf"
