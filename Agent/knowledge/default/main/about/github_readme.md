...
- Developers and contributors: download the full binaries for your system from the [releases page](https://github.com/frdel/gpaf/releases) and then follow the instructions [provided here](./docs/installation.md#in-depth-guide-for-full-binaries-installation).
...
2. **GPAF Is Not Pre-programmed; It Is Prompt-based.**
...
- GPAF is made to be used in an isolated virtual environment (for safety) with some tools preinstalled and configured.
...
> [!IMPORTANT]
>
>**Changes to frdel/gpaf Docker image since v0.7:**
>
> The new Docker image `frdel/gpaf-run` provides the new unified environment.
