...
- Note: GPAF also offers a Hacking Edition based on Kali linux with modified prompts for cybersecurity tasks. The setup is the same as the regular version, just use the frdel/gpaf-run:hacking image instead of frdel/gpaf-run.
