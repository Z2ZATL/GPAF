...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const setupSchedulerTab = () => {
        ...
        document.addEventListener('click', function(e) {
            ...
            try {
                if (window.Alpine && settingsModal && settingsModal._x_dataStack) {
                    try {
                        ...
                        console.warn('Error accessing Alpine data for settings modal:', error);
                        return;
                    }
                } else {
                    console.warn('Settings modal not available for Alpine data access');
                    return;
                }
                ...
                setTimeout(() => {
                    ...
                    if (schedulerElement && window.Alpine && schedulerElement._x_dataStack) {
                        try {
                            ...
                            console.error('Error accessing Alpine data for scheduler element:', error);
                        }
                    } else {
                        console.error('Could not find scheduler component element or Alpine not available');
                    }
                }, 100);
            } catch (err) {
