...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Any other parameters supported by the model. Format is KEY=VALUE on individual lines, just like .env file. For Typhoon, you can set temperature, max_tokens, top_p, frequency_penalty, and presence_penalty here.",
            "type": "textarea",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
        "description": "Selection and settings for main chat model used by GPAF. Supports OpenAI, Anthropic, Google, Mistral AI, Groq, DeepSeek, OpenRouter, Sambanova, Typhoon and other OpenAI compatible models.",
    ...
    api_keys_fields.append(_get_api_key_field(settings, "typhoon", "Typhoon API Key"))
    ...
    agent_fields.append(
        SettingsField(
            ...
            options=[FieldOption(value="automatic", label="Automatic")] + [
    ...
    stt_fields.append(
        SettingsField(
            ...
            options=[
                FieldOption(value="automatic", label="Automatic"),
    ...
    mcp_server_section: SettingsSection = {
        "id": "mcp_server",
        "icon": "api_keys",  # Using API keys icon for server connections
